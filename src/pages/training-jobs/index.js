          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="px-4 py-10 text-center sm:px-6 lg:px-8">
              ...
              <p className="mx-auto mt-4 max-w-xl text-base text-gray-500">
                Browse the top active training requirements and apply for the
                ones that match your skill.
              </p>
            </div>
            <div className="flex items-baseline justify-between border-b border-gray-200 py-6 ">
              <p className="font-bold tracking-tight text-gray-900">Filters</p>
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  {isGridView ? <TrainingJobsGrid /> : <TrainingJobsList />}
...
export default TrainingsJobsPage
